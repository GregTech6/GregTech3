...
public class BenderRecipeHandler extends GT_RecipeHandler {
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		...
		gui.drawText(30, 80, new StringBuilder().append("EU: ").append(toNumber(time*((CachedBenderRecipe)arecipes.get(recipe)).mEUt)).toString(), 0xFF000000, false);
		gui.drawText(30, 90, new StringBuilder().append("Time: ").append(toNumber(time/20)).append(" secs").toString(), 0xFF000000, false);
		gui.drawText(30,100, new StringBuilder().append("MaxEnergy: ").append(toNumber(((CachedBenderRecipe)arecipes.get(recipe)).mEUt)).append(" EU/t").toString(), 0xFF000000, false);
