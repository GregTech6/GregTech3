...
public class DenseLiquidFuelsHandler extends GT_RecipeHandler {
	
	public class CachedDenseLiquidFuels extends CachedGT_Recipe {
		public int mStartEU;
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		CachedDenseLiquidFuels t = ((CachedDenseLiquidFuels)arecipes.get(recipe));
