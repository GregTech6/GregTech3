...
public class TurbineFuelsHandler extends GT_RecipeHandler {
	
	public class CachedTurbineFuels extends CachedGT_Recipe {
		public int mStartEU;
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		CachedTurbineFuels t = ((CachedTurbineFuels)arecipes.get(recipe));
