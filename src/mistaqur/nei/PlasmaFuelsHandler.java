...
public class PlasmaFuelsHandler extends GT_RecipeHandler {
	
	public class CachedPlasmaFuels extends CachedGT_Recipe {
		public int mStartEU;
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		CachedPlasmaFuels t = ((CachedPlasmaFuels)arecipes.get(recipe));
