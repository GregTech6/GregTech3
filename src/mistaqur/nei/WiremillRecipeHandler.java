...
public class WiremillRecipeHandler extends GT_RecipeHandler {
	...
	public class CachedWiremillRecipe extends CachedGT_Recipe {
		...
		public CachedWiremillRecipe(GT_Recipe aRecipe) {
			...
			if (aRecipe.mInput1 != null)
				resources.add(new PositionedStack(aRecipe.mInput1, 53 - xoffset, 25 - yoffset));
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		...
		gui.drawText(30, 80, new StringBuilder().append("EU: ").append(toNumber(time*((CachedWiremillRecipe)arecipes.get(recipe)).mEUt)).toString(), 0xFF000000, false);
		gui.drawText(30, 90, new StringBuilder().append("Time: ").append(toNumber(time/20)).append(" secs").toString(), 0xFF000000, false);
		gui.drawText(30,100, new StringBuilder().append("MaxEnergy: ").append(toNumber(((CachedWiremillRecipe)arecipes.get(recipe)).mEUt)).append(" EU/t").toString(), 0xFF000000, false);
