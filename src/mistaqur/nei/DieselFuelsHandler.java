...
public class DieselFuelsHandler extends GT_RecipeHandler {
	
	public class CachedDieselFuels extends CachedGT_Recipe {
		public int mStartEU;
	...
	public void drawExtras(GuiContainerManager gui, int recipe) {
		CachedDieselFuels t = ((CachedDieselFuels)arecipes.get(recipe));
