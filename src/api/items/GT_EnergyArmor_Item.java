...
public class GT_EnergyArmor_Item extends ItemArmor implements IPlayerTickingItem, ISpecialArmor {
	...
	public boolean onTick(EntityPlayer aPlayer, ItemStack aStack, int aTimer, boolean aIsArmor) {
		...
		if (!aPlayer.worldObj.isRemote && (mSpecials & (16|32)) != 0) {
			if (aTimer%20==0) {
				...
				if (GT_ModHandler.dischargeElectricItem(tTargetDechargeItem, 10, Integer.MAX_VALUE, true, true) < 10) {
        ...
        if (!var1.entity.worldObj.isRemote && var1.entity instanceof EntityPlayer) {
            ...
            for (int i = 0; i < 4; i++) {
	            ...
	            if (var3 != null && var3.getItem() == this && (mSpecials & 2) != 0) {
	                ...
	                if (var5 <= GT_ModHandler.dischargeElectricItem(var3, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true)) {
	                    GT_ModHandler.dischargeElectricItem(var3, var5, Integer.MAX_VALUE, true, false);
    ...
    public ISpecialArmor.ArmorProperties getProperties(EntityLiving var1, ItemStack var2, DamageSource var3, double var4, int var6) {
    	return new ISpecialArmor.ArmorProperties((var3 == DamageSource.fall && (mSpecials & 2) != 0)?10:0, getBaseAbsorptionRatio() * mArmorAbsorbtionPercentage, mDamageEnergyCost > 0 ? 25 * GT_ModHandler.dischargeElectricItem(var2, Integer.MAX_VALUE, Integer.MAX_VALUE, true, true) / mDamageEnergyCost : 0);
    }
    ...
    public void damageArmor(EntityLiving var1, ItemStack var2, DamageSource var3, int var4, int var5) {
        GT_ModHandler.dischargeElectricItem(var2, var4 * mDamageEnergyCost, Integer.MAX_VALUE, true, false);
    }
