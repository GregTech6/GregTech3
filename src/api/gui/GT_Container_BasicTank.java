...
public class GT_Container_BasicTank extends GT_ContainerMetaTile_Machine {
    ...
    public void detectAndSendChanges() {
    	...
    	if (((GT_MetaTileEntity_BasicTank)mTileEntity.getMetaTileEntity()).mLiquid != null)
    		mContent = ((GT_MetaTileEntity_BasicTank)mTileEntity.getMetaTileEntity()).mLiquid.amount;
    	else
    		mContent = 0;
