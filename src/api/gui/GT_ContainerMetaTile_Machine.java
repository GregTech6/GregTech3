...
public class GT_ContainerMetaTile_Machine extends GT_Container {
    ...
    public  int mActive = 0, mMaxProgressTime = 0, mProgressTime = 0, mMJ = 0, mEnergy = 0, mMJStorage = 0, mStorage = 0, mOutput = 0, mInput = 0, mID = 0, mDisplayErrorCode = 0;
    private int oActive = 0, oMaxProgressTime = 0, oProgressTime = 0, oMJ = 0, oEnergy = 0, oMJStorage = 0, oStorage = 0, oOutput = 0, oInput = 0, oID = 0, oDisplayErrorCode = 0, mTimer = 0;
    
    @Override
    public void detectAndSendChanges() {
        super.detectAndSendChanges();
    	if (mTileEntity.isClientSide()) return;
        mStorage = mTileEntity.getEnergyCapacity();
    	mEnergy = mTileEntity.getEnergyStored();
    	mMJ = mTileEntity.getStoredMJ();
    	mOutput = mTileEntity.getOutputVoltage();
    	mInput = mTileEntity.getMetaTileEntity().maxEUInput();
