...
public class GT_MetaItem_Plasma extends GT_MetaItem_Abstract {
	...
	public GT_MetaItem_Plasma(int aID, String aName) {
		super(aID, aName);
		instance = this;
	}
	...
	public static ItemStack addItem(int aMeta, String aName, String aMaterial, String aToolTip, ItemStack aFullContainer, ItemStack aEmptyContainer) {
		GT_LanguageManager.addStringLocalization(instance.getUnlocalizedName() + "." + aMeta + ".name", aName + " Plasma");
		
		instance.mToolTipList[aMeta] = aToolTip;
		
		if (aMaterial != null && !aMaterial.equals("")) {
			instance.mStackList[aMeta] = LiquidDictionary.getOrCreateLiquid("plasma"+aMaterial, new LiquidStack(instance.itemID, 1000, aMeta)).asItemStack();
		} else {
