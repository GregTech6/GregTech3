...
public class GT_BlockMetaID_Block2 extends Block {
	...
	public Icon[] mIcons = new Icon[40];
    ...
    public Icon getBlockTexture(IBlockAccess aWorld, int xCoord, int yCoord, int zCoord, int aSide) {
		...
		if (tMeta < 8 || tMeta > 9 || (xCoord == 0 && yCoord == 0 && zCoord == 0) || !GT_BlockMetaID_Block.mConnectedMachineTextures) return this.getBlockTextureFromSideAndMetadata(aSide, tMeta);
