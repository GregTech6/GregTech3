...
public class GT_MetaTileEntity_AdvancedTranslocator extends MetaTileEntity {
	...
	public void onPostTick() {
		if (getBaseMetaTileEntity().isAllowedToWork() && getBaseMetaTileEntity().isServerSide() && getBaseMetaTileEntity().getEnergyStored() >= 1800 && (getBaseMetaTileEntity().hasWorkJustBeenEnabled() || getBaseMetaTileEntity().getTimer()%200 == 0 || (getBaseMetaTileEntity().getTimer()%5 == 0 && mSuccess > 0) || mSuccess >= 20)) {
			mSuccess--;
