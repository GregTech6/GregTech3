    ...
    private boolean checkRecipe() {
    	...
    	if (tRecipe != -1) {
    		if (spaceForOutput(tRecipe)) {
    			if (GT_Recipe.isRecipeInputEqual(true, true, mInventory[0], mInventory[1], GT_Recipe.sGrinderRecipes.get(tRecipe))) {
    		...
    		if (tRecipe != -1 && spaceForOutput(tRecipe)) {
    			if (GT_Recipe.isRecipeInputEqual(true, true, mInventory[0], tWaterStack, GT_Recipe.sGrinderRecipes.get(tRecipe))) {
		        	if (mInventory[0] != null) if (mInventory[0].stackSize == 0) mInventory[0] = null;
