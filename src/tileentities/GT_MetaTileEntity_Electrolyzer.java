...
public class GT_MetaTileEntity_Electrolyzer extends MetaTileEntity {
    ...
    private boolean checkRecipe() {
    	...
    	if (tRecipe != -1) {
    		if (spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, mInventory[0], mInventory[1], GT_Recipe.sElectrolyzerRecipes.get(tRecipe))) {
    	...
    	if (tRecipe != -1) {
    		if (spaceForOutput(tRecipe) && GT_Recipe.isRecipeInputEqual(true, true, mInventory[6], mInventory[1], GT_Recipe.sElectrolyzerRecipes.get(tRecipe))) {
