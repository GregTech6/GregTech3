...
public class GT_MetaTileEntity_Extractor extends GT_MetaTileEntity_BasicMachine {
    ...
    public void checkRecipe() {
    	...
    	if (mInventory[2] != null && spaceForOutput(GT_ModHandler.getExtractorOutput(mInventory[2], false), null) && null != (mOutputItem1 = GT_ModHandler.getExtractorOutput(mInventory[2], true))) {
    		mEUt = 2;
